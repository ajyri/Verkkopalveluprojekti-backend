...
drop table if exists tuoteryhma, tilausrivi, tilaus, tuote;
...
insert into tuoteryhma(trnimi) values ('Kahvit'),('Teet'),('Muut juomat'),('Leivokset');
...
('Jäälatte','Jääpaloilla höystetty latte.',2.50,1),('Earl Grey', 'Maustettu musta tee.', 1, 2),
('Kamomillatee', 'Rauhoittava tee.', 2, 2),('Vihreä tee', 'Maailman suosituin teelaji.',1.50, 2),
('Valkoinen tee', 'Vähiten käsitelty ja luonnonmukaisin.', 2.20, 2), ('Oolong','Osittain hapatettu tee.',3.10,2),
('Rooibos', 'Kafeiiniton yrttitee.', 2.50, 2),('Kaakao', 'Suklaakaakao.',2, 3), ('Jäävesi', 'Kylmä vesi.', 0.2, 3),
('Jaffa', 'Appelsiinilimsa.', 3, 3),('Cola', 'Colanmakuinen limsa.', 3, 3),('Omenamehu', 'Omenantuoremehu.', 3, 3),
('Appelsiinimehu', 'Appelsiinituoremehu.', 3, 3),('Brownie', 'Suklaaleivos.',3.35,4),
...
-- Vaihdetaan muiden juomien ja teen järjestystä
UPDATE tuoteryhma SET trnimi = 'Tee' WHERE trnro = 2;
UPDATE tuoteryhma SET trnimi = 'Muut juomat' WHERE trnro = 3;
UPDATE tuoteryhma SET trnimi = 'Teet' WHERE trnro = 2;
UPDATE tuote SET trnro = 2 WHERE trnro = 3;
UPDATE tuote SET trnro = 3 WHERE tuotenimi = 'Kaakao' OR tuotenimi =  'Jäävesi' OR tuotenimi = 'Jaffa' OR tuotenimi = 'Cola' OR tuotenimi = 'Omenamehu' OR tuotenimi = 'Appelsiinimehu';